...
Este projeto tem como objetivo a identificação de fraudes em transações de cartão de crédito utilizando Machine Learning supervisionado, tratando o problema como uma tarefa de classificação binária (fraude vs. não fraude).
